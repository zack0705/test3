...
<Card color={project.color} href={`${base}/projects/${project.slug}`} bgImg={getAssetURL(project.logo)}>
	...
	<p class="text-[0.95em] text-[var(--secondary-text)] font-400 m-t-20px m-b-40px flex-1">
