...
const Assets = {
	...
	Music: a('music.jpg'),
	Tank: a('tank.jpg'),
	Parallel: a('parallel.svg'),
	Bi_Di: a('bi-di.png'),
	Sarcasm: a('sarcasm.jpg'),
	Health: a('health.webp'),
	Job: a('job.webp'),
	ASU: a('asu.webp'),
	SmartBridge: a('smart-bridge.jpg'),
	CareerLauncher: a('career-launcher.png'),
	SQL: a('sql.png'),
	Sklearn: a('sklearn.png'),
